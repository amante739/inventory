            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form role="form" action="{{ route('rankcontents.update', $content_data ->id) }}" method="post">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="rank_content_title"
                                                id="rank_content_title" value="{{ $content_data ->rank_content_title }}"
                                                placeholder="Title">
                                        </div>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="rank_amount"
                                                        value="{{ $content_data ->rank_amount }}" id="rank_amount"
                                                        placeholder="Amount">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="rank_content_note"
                                                        value="{{ $content_data ->rank_content_note }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="rank_average_amount"
                                                value="{{ $content_data ->rank_average_amount }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="rank_content_description"
                                                id="rank_content_description" cols="30"
                                                rows="5">{{ $content_data ->rank_content_description }}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="rank_content_status	">Review Status</label>
                                            <select name="rank_content_status" id="rank_content_status"
                                                class="form-control">
                                                <option value="">Select Option</option>
                                                <option value="1"
                                                    {{ $content_data->rank_content_status	 == 1 ? 'selected' : '' }}>
                                                    Active
                                                </option>
                                                <option value="0"
                                                    {{ $content_data->rank_content_status	 == 0 ? 'selected' : '' }}>
                                                    Inactive
                                                </option>
                                            </select>
                                        </div>
